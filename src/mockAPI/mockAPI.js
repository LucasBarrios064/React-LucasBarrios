const data = [
    ...
    },
    {
        ...
        price: 990,
        expired: false,
        detail: "Demon Slayer Kimetsu No Yaiba Ivrea Manga Tomos, tomos del 1 al 21 $990 c/u.",
        stock: 21,
        category: "Mangas",
    },
    {
    ...
    },
    {
        ...
        price: 3200,
        expired: true,
        detail: "Remera Estilo Chainsaw Man con estampado de Pochita. Talles disponible XXL/XL/L/S",
        stock: 15,
        category: "Vestimenta",
    },
    {
        ...
        price: 13500,
        expired: false,
        detail: "Figura de Nobara Kugisaki del anime Jujutsu Kaisen. 15cm de Altura. Producto Original importado de Japon. ",
        stock: 5,
        category: "Figuras",
    },
    {
        ...
        price: 18500,
        expired: true,
        detail: "Figura de Tanjiro del anime Demon Slayer. 20cm de Altura. Producto Original importado de Japon. ",
        stock: 7,
        category: "Figuras",
    },
    {
        ...
        price: 8690,
        expired: true,
        detail: "Frazada con estampado estilo de Sailor Moon. Medidas: 1,4m X 1,4m.",
        stock: 18,
        category: "Decoracion",
    },
    {
...
export function getDataCategory(idCategoryParams) {
    return new Promise((resolve) => {
        let filterItem = data.filter((item) =>
            item.category === idCategoryParams
        )
